...
/// `lilypond/` and `lyrics/` directories, replacing the local copies.
pub fn download_and_extract(zipball_url: &str, tag: &str) -> Result<(), String> {
    ...
    // The parent directory that contains lilypond/ and lyrics/
    ...
    for i in 0..archive.len() {
        ...
        // Only extract lilypond/ and lyrics/ directories
